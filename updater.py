...
def make_shield(label, endpoint):
    return '![Results {}](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fmadavidcoder.pythonanywhere.com%2Fresults-{}&query=value&label={}&dummyresetter{}=123&cacheSeconds=0&t=1)'.format(endpoint, endpoint, label.replace(' ', '%20'),endpoint)
